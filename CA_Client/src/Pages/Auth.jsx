...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-cover bg-center bg-[url('./src/Images/back3.jpg')] pl-20">
...
//   return (
//     <div className="min-h-screen flex items-center justify-center bg-[url('/img/45.jpg')]">
//       <div className="bg-white p-8 rounded shadow-md w-full max-w-md">
//         <h2 className="text-2xl font-bold mb-6 text-center">
//           {Login ? "Please SignIn" : "Please SignUp"}
//         </h2>
//         <div className="flex justify-around mb-6">
//           <button
//             className={py-2 px-4 font-bold ${
...
//           {!Login && (
//             <button
//               className="text-blue-500 hover:underline pl-[35%]"
//               onClick={passfor}
//             >
//               Forgot password
//             </button>
